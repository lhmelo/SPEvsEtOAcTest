---
title: "QCcleanup_RecoveryTest_HILIC_SPEpH2"
date: July 26, 2017
...
datapath <- "~/Desktop/MetabolomicsProjects/SPEvsEtOAcTest/RecoveryTests/HILIC_pH2"
...
```{r}
setwd("~/Desktop/MetabolomicsProjects/SPEvsEtOAcTest/RecoveryTests/HILIC_pH2")
...
```{r}
setwd(datapath)
filename <- "QC_outputHILIC_SPErecovery_pH2_PPL"
...
#Calculate Recovery using BMIS normalized areas
...
setwd(datapath)
  write.csv(Recovery, "RecoveryValues_postBMIS_pH2_HILIC.csv")
```
...
setwd(datapath)
  write.csv(Recovery_raw, "RecoveryValues_rawareas_pH2_HILIC.csv")
```
...
setwd(datapath)
write_csv(data_nospike_conc, "BackgroundConcentrations_SPE_pH2_HILIC.csv")
